                    ...
                    <div class="col-4">
                        <div class="wrap-follow">
                            ...
                            <ul>
                                ...
                                <li>
                                   <img src="assets/icon/telegram.png" width="40px"> <a href="https://t.me/RA_MEY1">Telegram</a>
                                </li>
                                <li>
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="box"  name="telephone" placeholder="Telephone" required minlength="9" maxlength="10">
                                    </div>
                                    <div class="col-6">
